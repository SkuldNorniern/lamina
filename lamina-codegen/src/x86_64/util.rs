...
use lamina_mir::{Register, VirtualReg};

/// Load a virtual register into RAX
pub fn load_register_to_rax<
    W: std::io::Write,
    RA: crate::regalloc::RegisterAllocator<PhysReg = &'static str>,
>(
    reg: &VirtualReg,
    writer: &mut W,
    reg_alloc: &RA,
...
>(
    ...
    match operand {
        lamina_mir::Operand::Register(reg) => match reg {
        ...
        lamina_mir::Operand::Immediate(imm) => match imm {
            lamina_mir::instruction::Immediate::I8(v) => {
                writeln!(writer, "    movq ${}, %rax", *v as i64)
            }
            lamina_mir::instruction::Immediate::I16(v) => {
                writeln!(writer, "    movq ${}, %rax", *v as i64)
            }
            lamina_mir::instruction::Immediate::I32(v) => {
                writeln!(writer, "    movq ${}, %rax", *v as i64)
            }
            lamina_mir::instruction::Immediate::I64(v) => writeln!(writer, "    movq ${}, %rax", v),
            lamina_mir::instruction::Immediate::F32(_)
            | lamina_mir::instruction::Immediate::F64(_) => {
                writeln!(
                    writer,
...
>(
    ...
    match operand {
        ...
        lamina_mir::Operand::Immediate(imm) => match imm {
            ...
            lamina_mir::instruction::Immediate::I64(v) => {
